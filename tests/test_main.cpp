...
TEST(OrderBookEntryTest, StringToOrderBookType) {
    ...
    EXPECT_EQ(OrderBookEntry::stringToOrderBookType("unknown_type"),
              OrderBookType::unknown);
}

// Test OrderBookEntry creation
TEST(OrderBookEntryTest, Constructor) {
    OrderBookEntry entry(100.5, 2.0, "2020/03/17 17:01:24.884492", "BTC/USDT",
                         OrderBookType::bid, "user1");
...
TEST(OrderBookEntryTest, CompareFunctions) {
    OrderBookEntry e1(100.0, 1.0, "2020/03/17 17:01:24", "BTC/USDT",
                      OrderBookType::bid);
    OrderBookEntry e2(200.0, 1.0, "2020/03/17 17:01:25", "BTC/USDT",
                      OrderBookType::bid);
...
TEST(OrderBookTest, GetMeanPrice) {
    ...
    orders.push_back(OrderBookEntry(100.0, 1.0, "2020/03/17 17:01:24",
                                    "BTC/USDT", OrderBookType::bid));
    orders.push_back(OrderBookEntry(200.0, 1.0, "2020/03/17 17:01:24",
                                    "BTC/USDT", OrderBookType::bid));
    orders.push_back(OrderBookEntry(300.0, 1.0, "2020/03/17 17:01:24",
                                    "BTC/USDT", OrderBookType::bid));
...
TEST(OrderBookTest, GetHighLowPrice) {
    std::vector<OrderBookEntry> orders;
    orders.push_back(OrderBookEntry(150.0, 1.0, "2020/03/17 17:01:24",
                                    "BTC/USDT", OrderBookType::bid));
    orders.push_back(OrderBookEntry(200.0, 1.0, "2020/03/17 17:01:24",
                                    "BTC/USDT", OrderBookType::bid));
    orders.push_back(OrderBookEntry(100.0, 1.0, "2020/03/17 17:01:24",
